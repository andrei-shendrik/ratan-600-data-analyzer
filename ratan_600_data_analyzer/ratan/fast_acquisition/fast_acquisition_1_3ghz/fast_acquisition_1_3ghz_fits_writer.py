...
class FastAcquisition1To3GHzFitsWriter(RatanObservationWriter):
    ...
    def save(self, output_fits_file: Path):
        """
            ...
            T_CULM_EFRAT // Кульминация по EFRAT
            T_CULM_OFFSET // Кульминация с учетом выноса рупора
            T_OBS_START
            T_OBS_STOP
            FEED_OFFSET // Вынос рупора, см
            FEED_OFFSET_TIME // Вынос рупора по времени
            ...
            BAND
            ATT1 // Common
            ATT2 // 1 - 2 GHz channel attenuation
            ATT3 // 2 - 3 GHz channel attenuation
